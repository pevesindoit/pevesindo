            ...
            <div className="w-full flex justify-center px-[1rem] z-0">
                <div className="w-[95%]">
                    <div className="flex">
                        ...
                        <button className={`cursor-pointer px-[1rem] py-[.5rem] border-x-[1px] border-t-[1px]   rounded-t-md ${path === "/sales-counter/list-produk" ? " bg-blue-400 text-white rounded-t-md" : ""}`}>
                            Produk
                        </button>
