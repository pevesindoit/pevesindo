...
export default function Page() {
    ...
    const changePage = (e: any) => {
        if (e === "list") {
            route.push("/sales-counter/list-produk")
        } else if (e === "lokasi") {
            route.push("/sales-counter/lokasi-driver")
        }
    }
    ...
    return (
        <div className="py-[2rem]">
            ...
            <div className="w-full flex justify-center px-[1rem] z-0">
                <div className="w-[95%]">
                    <div className="flex">
                        <div className={`cursor-pointer px-[1rem] py-[.5rem] ${path === "/sales-counter" ? "bg-green-600 text-white rounded-t-md" : ""}`}>
                            Pengantaran
                        </div>
            ...
            <div className="w-full justify-center flex ">
                <div className="z-50 bg-white rounded-[10px] border border-[#E3E7EC] text-[.6rem] py-[2rem] w-[95%] px-[2rem] space-y-[2rem]">
                    ...
                    <div className="grid md:grid-cols-5 grid-cols-3 gap-[.5rem]">
                        <Button
